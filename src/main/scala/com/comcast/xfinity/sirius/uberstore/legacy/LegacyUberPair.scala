...
object LegacyUberPair {
   ...
   */
  def apply(baseDir: String, startingSeq: Long): LegacyUberPair = {
    ...
    new LegacyUberPair(dataFile, index)
  }
 ...
 */
class LegacyUberPair(dataFile: UberDataFile, index: SeqIndex) {
