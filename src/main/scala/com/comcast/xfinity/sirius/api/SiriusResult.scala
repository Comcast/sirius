...
object SiriusResult {
   ...
   * @return SiriusResult
   */
  def some(value: Object): SiriusResult = SiriusResult(Some(value))
...
case class SiriusResult(private val value: Object) {
  ...
  override def equals(that: Any) = that match {
    ...
    case SiriusResult(thatValue) => this.value == thatValue
    case _ => false
  }
